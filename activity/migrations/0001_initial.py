...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'activity_activityinstance', (
            ...
            ('endTime', self.gf('django.db.models.fields.DateTimeField')(blank=True)),
        ...
        db.create_table(u'activity_rateactivity', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('activity', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='rateActivities', null=True, to=orm['activity.Activity'])),
        ...
        db.create_table(u'activity_rateactivityinstance', (
            ...
            ('activityInstance', self.gf('django.db.models.fields.related.ForeignKey')(related_name='rateActivityInstances', to=orm['activity.ActivityInstance'])),
        ))
    ...
    models = {
        ...
        u'activity.rateactivityinstance': {
            ...
            'activityInstance': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'rateActivityInstances'", 'to': u"orm['activity.ActivityInstance']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
