...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'activity_activityinstance', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('startTime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 1, 18, 0, 0), blank=True)),
            ('endTime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 1, 18, 0, 0), blank=True)),
        ...
        db.create_table(u'activity_rateactivityinstance', (
            ...
            ('activityInstance', self.gf('django.db.models.fields.related.ForeignKey')(related_name='rateActivityInstances', blank=True, to=orm['activity.ActivityInstance'])),
        ))
    ...
    models = {
        ...
        u'activity.activityinstance': {
            ...
            'endTime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 18, 0, 0)', 'blank': 'True'}),
            ...
            'startTime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 18, 0, 0)', 'blank': 'True'})
        },
